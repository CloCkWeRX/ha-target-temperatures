...
class TargetTemperature(NumberEntity):
    ...
    def __init__(self, area, helper):
        ...
        self._attr_native_unit_of_measurement = helper["unit_of_measurement"]
        self._attr_native_min_value = helper["min_value"]
        self._attr_native_max_value = helper["max_value"]
        self._attr_native_step = helper["step"]
        self._attr_native_value = helper["min_value"]
